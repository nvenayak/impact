...
# -*- coding: utf-8 -*-
#
# Fermentation Data Analysis and Plotting Inventory documentation build configuration file, created by
...
# ones.
extensions = [
    'sphinx.ext.autodoc','nbsphinx','sphinx.ext.mathjax','IPython.sphinxext.ipython_console_highlighting',
...
exclude_patterns = ['_build', '**.ipynb_checkpoints', '*WIP*', '*deprecated*']
...
html_theme_options = {
    ...
    # 'script_files': ['https://cdnjs.cloudflare.com/ajax/libs/require.js/2.3.3/require.min.js']
}
